...
export const NOTICES_DATA: NoticeItem[] = [
  ...
  },
  {
    ...
    noticeNo: "NCIE-RECTT-2026-001",
    date: "July 01, 2026",
    title: "NCIE Contractual Recruitment Notification July 2026: 773 Vacancies Across 21 Administrative & Technical Positions",
    description: "Applications are invited from eligible Indian citizens for engagement to various contractual positions (1 Year tenure, AP posting). Positions include State Program Manager, Regional Innovation Officers, Incubator Managers, and Technical Leads. Last date to apply: August 25, 2026.",
    category: "Recruitment",
    issuingAuthority: "Human Resources & Administration Desk",
    fileUrl: "/careers",
    fileSize: "Web Portal",
    isNew: true,
    isImportant: true,
    tags: ["Recruitment", "Jobs", "Contractual", "AP Posting"],
  },
  {
    id: "iic-int-2026-001",
