...
export const PROGRAMS_DATA: Program[] = [
  // --- OFFICIAL 45-DAY CERTIFICATE COURSES (NCIE-IEDP) ---
  {
    ...
    pdfUrl: "/Rules, Regulations & Guidelines_NCIE Student Startup Grants Program.pdf",
    pdfName: "Rules, Regulations & Guidelines_NCIE Student Startup Grants Program.pdf",
    benefits: [
  ...
  // --- CORE INSTITUTIONAL & STUDENT SCHEMES ---
  {
    ...
    pdfUrl: "/NCIE – Viksit Bharat 2047 Innovation Leadership Programmes.pdf",
  ...
  },
  {
    ...
    pdfUrl: "/Dr. A.P.J. Abdul Kalam Startup Validation & Seed Funding Scheme.pdf",
  ...
  },
  {
    ...
    pdfUrl: "/Institutional Incubation & Development Support Scheme (IIDSS) (1).pdf",
    pdfName: "Institutional Incubation & Development Support Scheme (IIDSS) (1).pdf",
    benefits: [
