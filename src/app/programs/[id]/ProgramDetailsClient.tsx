              ...
              <div className="text-center sm:text-left space-y-1.5 mt-2">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-zinc-400">
                    {language === "hi" ? "राष्ट्रीय परिषद (NCIE) मुख्यालय" : "NCIE Head Office, New Delhi"}
                  </p>
                </div>
              </div>
            ...
            <Card className="border border-zinc-300 shadow-lg rounded-sm bg-white overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <Link href="/Circular_Guidelines_2026.pdf" target="_blank" rel="noopener noreferrer" className="block">
