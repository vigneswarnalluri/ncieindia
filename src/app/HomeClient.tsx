    ...
    <div className="flex-1 bg-[#F9FAFB] pb-16 font-sans">
      ...
      <div className="bg-gradient-to-r from-[#074733] via-[#0A5D45] to-[#0D6B4F] text-white py-3.5 px-4 sm:px-6 lg:px-8 border-b border-[#C9A24B]/35">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <Link href="/join?role=internship" className="shrink-0 w-full md:w-auto group">
            <button className="w-full md:w-auto bg-white hover:bg-emerald-50/80 text-[#074733] font-bold text-xs uppercase tracking-wider px-5 py-2.5 rounded-md border border-[#C9A24B]/70 hover:border-[#C9A24B] shadow-sm hover:shadow-md transition-all duration-200 inline-flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98]">
              <span>{t("banner_register_now")}</span>
              <ArrowRight className="w-3.5 h-3.5 text-[#0D6B4F] transition-transform duration-200 group-hover:translate-x-1" />
            </button>
          </Link>
        </div>
      </div>
