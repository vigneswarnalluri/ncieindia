            ...
            <div className="bg-white border border-zinc-200 rounded-none p-6 sm:p-8 space-y-6">
              ...
              <div className="space-y-6 text-xs sm:text-sm">
                <div className="flex gap-3.5">
                  ...
                  <div>
                    <h4 className="font-bold text-zinc-800 uppercase tracking-wide">Main Head Office (HQ)</h4>
                ...
                <div className="flex gap-3.5 pt-4 border-t border-zinc-100">
                  <MapPin className="w-5 h-5 text-emerald-600 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-bold text-zinc-800 uppercase tracking-wide">Nodal &amp; Implementation Agency</h4>
                    <p className="text-zinc-500 mt-1 leading-relaxed">
                      NCIE Desk, Guntur,<br />
